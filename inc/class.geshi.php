...
/** The language file directory for GeSHi
    @access private */
define('GESHI_LANG_ROOT', ROOT_PATH.'/geshi/');
...
class geshi {
    ...
    function set_header_content_class($style) {
        $this->header_content_class = $style;
    }
            ...
            foreach ($code as $line) {
                ...
                if ($this->line_numbers == GESHI_FANCY_LINE_NUMBERS &&
                    ...
                    if ($this->use_classes) {
                        ...
                        // code on that line
                        $def_attr = ' style="' . $this->code_style . ' ' .@$this->language_data['DEF_STYLE']. '"';
                    }
                    // Span or div?
                    $start = "<div$def_attr>";
                    $end = '</div>';
    ...
    function format_header_content() {
        ...
        if ($header) {
            ...
            if ($this->header_content_class!='')
                 $attr = " class=\"{$this->header_content_class}\"";
